...
class DepositLimitExceededModal extends React.Component<IProps & InjectedIntlProps> {
    ...
    return(
      <Modal.Error
        ...
        description={intl.formatMessage({
          id: 'dashboard.modal.withdrawFiat.informationLimitExceeded',
        }, {
          TierLevel: tierLevel,
...
export default injectIntl(DepositLimitExceededModal);